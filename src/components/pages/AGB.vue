<template>
    ...
    <v-container>
        ...
        <p>
            <ol>
                <li>Diese Verkaufsbedingungen gelten ausschließlich gegenüber Unternehmern, 
                    ...
                    wir nur an, wenn wir ausdrücklich schriftlich der Geltung zustimmen. </li>
                <li> Diese Verkaufsbedingungen gelten auch für alle zukünftigen Geschäfte mit dem 
                    Besteller, soweit es sich um Rechtsgeschäfte verwandter Art handelt (vorsorglich 
                    sollten die Verkaufsbedingungen in jedem Fall der Auftragsbestätigung beigefügt werden).</li>
                <li>Im Einzelfall getroffene, individuelle Vereinbarungen mit dem Käufer 
                    ...
                    Fall Vorrang vor diesen Verkaufsbedingungen. Für den Inhalt derartiger Vereinbarungen 
                    ist, vorbehaltlich des Gegenbeweises, ein schriftlicher Vertrag bzw. unsere schriftliche
                     Bestätigung maßgebend. </li>
            </ol>
        </p>
        ...
        es sei denn, wir erteilen dazu dem Besteller unsere ausdrückliche schriftliche Zustimmung. Soweit
        wir das Angebot des Bestellers nicht innerhalb der Frist von § 2 annehmen, sind diese Unterlagen 
        uns unverzüglich zurückzusenden.
        </p>
        <h4>§ 4 Preise und Zahlung</h4>
        <p>
        <ol>
            <li>Sofern nichts Gegenteiliges schriftlich vereinbart wird, gelten unsere Preise ab Werk ausschließlich 
            ...
            <li>Sofern nichts anderes vereinbart wird, ist der Kaufpreis innerhalb von 10 Tagen nach Lieferung zu 
                zahlen (Alternativen: „ ... ist der Kaufpreis innerhalb von 21 Tagen nach Rechnungsstellung zahlbar“ 
                oder „ ... ist der Kaufpreis bis zum - konkretes Datum - zahlbar“). Verzugszinsen werden in Höhe von 
                8 % über dem jeweiligen Basiszinssatz p.a. (siehe Anlage 1) berechnet. Die Geltendmachung eines höheren 
                Verzugsschadens bleibt vorbehalten.
            </li>
            <li>Sofern keine Festpreisabrede getroffen wurde, bleiben angemessene Preisänderungen wegen veränderter 
        ...
        <p>
        <ol>
            <li>Der Beginn der von uns angegebenen Lieferzeit setzt die rechtzeitige und ordnungsgemäße Erfüllung 
                der Verpflichtungen des Bestellers voraus. Die Einrede des nicht erfüllten Vertrages bleibt 
                vorbehalten.
            </li>
            <li>Kommt der Besteller in Annahmeverzug oder verletzt er schuldhaft sonstige Mitwirkungspflichten, 
            ...
            <li>Wir haften im Fall des von uns nicht vorsätzlich oder grob fahrlässig herbeigeführten Lieferverzugs 
                für jede vollendete Woche Verzug im Rahmen einer pauschalierten Verzugsentschädigung in Höhe von 3 % 
                des Lieferwertes, maximal jedoch nicht mehr als 15 % des Lieferwertes.
            </li>
            <li>Weitere gesetzliche Ansprüche und Rechte des Bestellers wegen eines Lieferverzuges bleiben unberührt.
            </li>
        </ol>
        </p>
        ...
        <p>
            <ol>
                <li>Wir behalten uns das Eigentum an der gelieferten Sache bis zur vollständigen Zahlung 
                ...
                <li>Der Besteller ist verpflichtet, solange das Eigentum noch nicht auf ihn übergegangen ist, 
                    ...
                    (Hinweis: nur zulässig bei Verkauf hochwertiger Güter). Müssen Wartungs- und Inspektionsarbeiten 
                    ...
                    ausgesetzt ist. Soweit der Dritte nicht in der Lage ist, uns die gerichtlichen und 
                    außergerichtlichen Kosten einer Klage gemäß § 771 ZPO zu erstatten, haftet der Besteller für 
                    den uns entstandenen Ausfall. 
                </li>
                <li>Der Besteller ist zur Weiterveräußerung der Vorbehaltsware im normalen Geschäftsverkehr berechtigt. 
                    ...
                    Zahlungseinstellung vorliegt. [Anmerkung: Diese Klausel entfällt, wenn kein verlängerter 
                    Eigentumsvorbehalt gewollt ist.]
                </li>
                <li>Die Be- und Verarbeitung oder Umbildung der Kaufsache durch den Besteller erfolgt stets Namens 
                    ...
                    erfolgt, dass die Sache des Bestellers als Hauptsache anzusehen ist, gilt als vereinbart, dass 
                ...
                <li>Wir verpflichten uns, die uns zustehenden Sicherheiten auf Verlangen des Bestellers freizugeben, 
        ...
        <p>
            <ol>
                <li>Gewährleistungsrechte des Bestellers setzen voraus, dass dieser seinen nach § 377 HGB geschuldeten 
                    Untersuchungs- und Rügeobliegenheiten ordnungsgemäß nachgekommen ist. 
                </li>
                <li>Mängelansprüche verjähren in 12 Monaten nach erfolgter Ablieferung der von uns gelieferten Ware 
                    ...
                    Pflichtverletzung des Verwenders beruhen, gilt die gesetzliche Verjährungsfrist. (Hinweis: bei 
                    dem Verkauf gebrauchter Güter kann die Gewährleistungsfrist mit Ausnahme der im Satz 2 genannten 
                    Schadensersatzansprüche ganz ausgeschlossen werden). <br>
                    Soweit das Gesetz gemäß § 438 Abs. 1 Nr. 2 BGB (Bauwerke und Sachen für Bauwerke), 
                    § 445 b BGB (Rückgriffsanspruch) und § 634a Absatz 1 BGB (Baumängel) längere Fristen 
                    zwingend vorschreibt, gelten diese Fristen. Vor etwaiger Rücksendung der Ware ist unsere 
                    Zustimmung einzuholen.
                </li>
                <li>Sollte trotz aller aufgewendeter Sorgfalt die gelieferte Ware einen Mangel aufweisen, der 
                ...
                <li>Schlägt die Nacherfüllung fehl, kann der Besteller – unbeschadet etwaiger Schadensersatzansprüche 
                    – vom Vertrag zurücktreten oder die Vergütung mindern.
                </li>
                <li>Mängelansprüche bestehen nicht bei nur unerheblicher Abweichung von der vereinbarten Beschaffenheit, 
                    ...
                    Beanspruchung, ungeeigneter Betriebsmittel, mangelhafter Bauarbeiten, ungeeigneten Baugrundes oder 
                    aufgrund besonderer äußerer Einflüsse entstehen, die nach dem Vertrag nicht vorausgesetzt sind. Werden 
                    vom Besteller oder Dritten unsachgemäß Instandsetzungsarbeiten oder Änderungen vorgenommen, so bestehen 
                    für diese und die daraus entstehenden Folgen ebenfalls keine Mängelansprüche. 
                </li>
                <li>Ansprüche des Bestellers wegen der zum Zweck der Nacherfüllung erforderlichen Aufwendungen, 
                    insbesondere Transport-, Wege-, Arbeits- und Materialkosten, sind ausgeschlossen, soweit die Aufwendungen 
                    sich erhöhen, weil die von uns gelieferte Ware nachträglich an einen anderen Ort als die Niederlassung 
                    des Bestellers verbracht worden ist, es sei denn, die Verbringung entspricht ihrem bestimmungsgemäßen 
                    Gebrauch. 
                </li>
                <li>Rückgriffsansprüche des Bestellers gegen uns bestehen nur insoweit, als der Besteller mit seinem 
                    Abnehmer keine über die gesetzlich zwingenden Mängelansprüche hinausgehenden Vereinbarungen getroffen hat.
                    Für den Umfang des Rückgriffsanspruches des Bestellers gegen den Lieferer gilt ferner Absatz 6 
                    entsprechend.
                </li>
            </ol>
        </p>
        ...
        <p>
            <ol>
                <li>Dieser Vertrag und die gesamten Rechtsbeziehungen der Parteien unterliegen dem Recht der 
                    Bundesrepublik Deutschland unter Ausschluss des UN-Kaufrechts (CISG).
                </li>
                <li>Erfüllungsort und ausschließlicher Gerichtsstand und für alle Streitigkeiten aus diesem 
                    Vertrag ist unser Geschäftssitz, sofern sich aus der Auftragsbestätigung nichts anderes ergibt 
                    (Hinweis: Die Verwendung der Klausel ist unzulässig, wenn mindestens eine der Parteien ein nicht 
                    im Handelsregister eingetragenes Unternehmen ist)
                </li>
                <li>Alle Vereinbarungen, die zwischen den Parteien zwecks Ausführung dieses Vertrages getroffen werden, 
